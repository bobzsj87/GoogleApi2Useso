chrome.webRequest.onBeforeRequest.addListener(
  function(info) {    
    ...
    //   return {redirectUrl: info.url.replace("fonts.googleapis.com", "fontsgoogle.campbbs.com.global.ssl.fastly.net")};
    // }
    // if (info.url.indexOf("https://ajax.googleapis.com/") !== -1){
    //   return {redirectUrl: info.url.replace("ajax.googleapis.com", "ajaxgoogle.campbbs.com.global.ssl.fastly.net")};
    // }
